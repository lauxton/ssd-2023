...
source foo_env/bin/activate
```
[Tip] If running Linux, make sure to have Django downloaded onto your virtual environment, and to have downloaded django-cryptography and django-csp before trying to migrate the server (Matthes, 2021; crypto, xxxx; Mozilla, 2016).
...
```
## Security Features
This application was designed with security features (django, 2023) in mind. The following commands were added to `settings.py` to achieve input santisation measures, session management, and data encryption:
```
...
LOGGING
```
These were added to application based on attack reports generated by Zaproxy during automatic and mantual scanning techniques:
...
* X-Content-Type-Options: https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP (Webhint, )
...
Access controls were handled by the admin (superuser) on the admin backend (see 1`27.0.0.1/admin`) and comprised of:
...
# References
* Django (2023) https://docs.djangoproject.com/en/4.2/intro/tutorial01/
* Django (2023) https://docs.djangoproject.com/en/4.1/topics/forms/
* LearnDjango ()https://learndjango.com/tutorials/django-login-and-logout-tutorial
Django (2023) https://docs.djangoproject.com/en/4.2/topics/security/
* LastPass (2023) https://www.lastpass.com/
Kiprin (2021) https://crashtest-security.com/server-version-fingerprinting/
* Pypi () https://pypi.org/project/pylint/
* Pypi () https://pypi.org/project/django-cryptography/
* Mozilla (2016) https://django-csp.readthedocs.io/en/latest/installation.html
Mozilla (2023) https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP
Webhint (n.d.) https://webhint.io/docs/user-guide/hints/hint-x-content-type-options/
* ZAP (2023) https://www.zaproxy.org/docs/desktop/start/features/ascan/