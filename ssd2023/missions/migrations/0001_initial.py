    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_security_number', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=9))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(blank=True, null=True, verbose_name='Date of commencement')),
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name='Date of completion')),
                ('security_clearance', models.IntegerField(choices=[(1, 'Baseline'), (2, 'Confidential'), (3, 'Secret'), (4, 'Top Secret')])),
                ('division', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='missions.division')),
                ('supervisor', models.ForeignKey(limit_choices_to={'user__groups__name': 'ISS_Admin_User'}, on_delete=django.db.models.deletion.CASCADE, to='missions.employee')),
            ],
        ),
        migrations.CreateModel(
            name='MissionReport',
